package com.lijiaxuan.project.service.util;
...
public class NameUtil {
        ...
        public static List<String> getAddr(){
    ...
    public static String getChineseName() {
        ...
        public  static  String kouwei(){
            String[] kouweis=new String[]{"辣","甜","酸","咸","淡","其它","辣","辣","辣","辣","辣","辣","酸","咸","淡","酸","咸","淡","甜","甜","甜"};
            Random random=new Random();
            int i = random.nextInt(kouweis.length);
            return  kouweis[i];

        }
        public  static  String fandain(){
            Random random=new Random();

            String[] canguan=new String[]{"锅贴好粥道","蜀味新派川菜","美蛙私厨","林记臭豆腐(知春路店)","望京小腰","麦当劳餐厅","美蛙鱼","东北饺子馆","哈尔滨烤冷面","一撸一夜烤坊","毛轩湘菜馆","常湘依湘菜馆","故里风土菜馆","威斯汀舞台餐厅","康乃馨食府","香满园川菜馆","五香咀川菜馆","豆花鱼川菜馆","老格蔸川菜","正宗川菜"};
            return  canguan[random.nextInt(canguan.length)];
        ...
        public  static  String zhiye(){
            Random random=new Random();
            String[]  zhiye=new String[]{"电子商务","电子商务","电子商务","电子商务","教育","教育","教育","IT/互联网","金融","金融","金融","金融","学生","其他","学生","学生","学生","学生","学生","学生","学生","IT/互联网","IT/互联网","IT/互联网","IT/互联网"};
            return   zhiye[random.nextInt(zhiye.length)];

        }
        public static  String getPhone(){
            Random random=new Random();
           String[] phone=new String[]{"安卓","ios"};
           return  phone[random.nextInt(phone.length)];

        }
        public static   Integer  qian(){
            Random random=new Random();

            return  random.nextInt(200)+10;
        }
